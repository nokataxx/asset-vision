...
| 項目 | 説明 | デフォルト値 | 楽観 | 悲観 |
|------|------|-------------|------|------|
| 通常期利回り | 通常期の年間利回り | 10% | 14% | 6% |
| 通常期標準偏差 | 通常期のリターンのばらつき | 13% | 10% | 18% |
| 暴落期利回り | 暴落期の年間利回り | -30% | -20% | -45% |
| 暴落期標準偏差 | 暴落期のリターンのばらつき | 28% | 20% | 35% |
| 戻り期利回り | 戻り期の年間利回り | 18% | 25% | 10% |
| 戻り期標準偏差 | 戻り期のリターンのばらつき | 22% | 18% | 28% |
| 暴落発生確率 | 1年あたりの暴落発生確率 | 15% | 8% | 25% |

※上記デフォルト値はS&P 500等の過去実績に基づく現実的な設定（名目リターン）。UIのレジーム設定タイトル横のℹ️アイコンをマウスオーバーすると参照値テーブルを表示。25%タイルを基準に計画を立てることを推奨。
